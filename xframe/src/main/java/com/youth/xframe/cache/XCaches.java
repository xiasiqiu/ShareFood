...
public class XCaches {
    ...
    private static Map<String, XCaches> mInstanceMap = new HashMap<String, XCaches>();
    private XCacheManager mCache;

    public static XCaches get(Context ctx) {
        return get(ctx, "XCaches");
    }

    public static XCaches get(Context ctx, String cacheName) {
        File f = new File(ctx.getCacheDir(), cacheName);
        return get(f, maxSize, maxCount);
    }

    public static XCaches get(File cacheDir) {
        return get(cacheDir, maxSize, maxCount);
    }

    public static XCaches get(Context ctx, long maxSize, int maxCount) {
        File f = new File(ctx.getCacheDir(), "XCaches");
        return get(f, maxSize, maxCount);
    }

    public static XCaches get(File cacheDir, long maxSize, int maxCount) {
        XCaches manager = mInstanceMap.get(cacheDir.getAbsoluteFile() + myPid());
        if (manager == null) {
            manager = new XCaches(cacheDir, maxSize, maxCount);
    ...
    private XCaches(File cacheDir, long maxSize, int maxCount) {
