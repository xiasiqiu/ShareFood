...
public class AddViewHolder {
    ...
    public AddViewHolder setImageRed(int viewId, String url) {
        ...
        Glide.with(this.context).load(url).placeholder((int) R.drawable.icon_null).error((int) R.drawable.img_defaule).centerCrop().into(new SimpleTarget<GlideDrawable>() {
            @Override
    ...
    public void setImageLocal(ImageView view, String url) {
        Glide.with(this.context).load(url).placeholder((int) R.drawable.icon_null).error((int) R.drawable.img_defaule).centerCrop().into(view);
    }
