...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.menu_de_color));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.menu_de_color));
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.button__b_bg_t);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.menu_de_color));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.menu_de_color));
        }
    }
