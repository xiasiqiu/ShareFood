...
/**
 * Created by f-x on 2017/11/3014:24
 */
...
public class SelectDialog extends Dialog implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.view_eva_dialog_select,
                null);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (null == convertView) {
                ...
                convertView = layoutInflater.inflate(R.layout.view_eva_dialog_item, null);
